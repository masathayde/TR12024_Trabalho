...
def amplitude_sk(amplitude = 1.0, frequency = 1.0, bit_list = [1,0], sample_num = 100):
...
def frequency_sk(amplitude = 1.0, frequency_0 = 1.0, frequency_1 = 2.0, bit_list = [1,0], sample_num = 100):
...
def eight_qam(amplitude = 1.0, frequency = 1.0, bits = [1,0,1,0], sample_num = 100):
    # Ângulo do sinal é alterado por um valor associado a tripla de bits considerada.
    signal = []
